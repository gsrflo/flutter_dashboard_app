    ...
    return Scaffold(
      ...
      body: StaggeredGridView.count(
        ...
        children: <Widget>[
          ...
          _buildTileCompetitors(_buildIcon(Icons.table_chart, 0xff44bbf4), "Competitors"),
          _buildTileRisk(_buildIcon(Icons.bubble_chart, 0xff44bbf4), "Risk"),
          _buildTileRevenue(_buildIcon(Icons.data_usage, 0xff44bbf4), "Revenue"),
